 ...
 */
    ...
    (() => {
        ...
        const inputMasks = document.querySelectorAll(".form-records__inp");
        if (inputMasks.length) modules_flsModules.inputmask = Inputmask("+7-9{1,3} 9{1,3}-9{1,2}-9{1,2}").mask(inputMasks);
        ...
        let menySliderProducts = [ "Популярные", "Бестселлеры", "Новинки" ];
        function initSliders() {
            ...
            if (document.querySelector(".products-top__slider")) new core(".products-top__slider", {
                ...
                simulateTouch: true,
                pagination: {
                    el: ".products-top__paginat",
                    clickable: true,
                    renderBullet: function(index, className) {
                        return '<span class="' + className + '">' + menySliderProducts[index] + "</span>";
                    }
                },
                breakpoints: {
                    320: {
            ...
            if (document.querySelector(".workshop__slider")) new core(".workshop__slider", {
                modules: [ Navigation ],
                slidesPerView: 3,
                spaceBetween: 15,
                autoHeight: true,
        ...
        da.init();
        const catalog_button = document.querySelector(".catalog-block-header__btn");
        catalog_button.addEventListener("click", (e => {
            const catalog_menu = document.querySelector(".catalog-body");
            catalog_menu.classList.toggle("_active");
        }));
        window["FLS"] = true;
        isWebp();
        menuInit();
